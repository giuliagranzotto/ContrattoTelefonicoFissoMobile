...
public class ContrattoMobile extends ContrattoTelefonico {
	private static final double COSTO_ALLA_RISPOSTA = 1.5;
    ...
    public void aggiornaBolletta(int sec) {
        super.aggiornaBolletta(sec);
        super.aggiornaCosto(COSTO_ALLA_RISPOSTA);
    }
    ...
    public void aggiungiTelefonateCasuali(int numeroTelefonate) {
        ...
        for (int i = 0; i < numeroTelefonate; i++) {
            ...
            double costo = tipo.equals("IN") ? 0.0 : sec * getCostoAlSec() + COSTO_ALLA_RISPOSTA;
            
//            LocalDate dataCasuale = now.minusDays(random.nextInt(365));  // Data casuale entro un anno da oggi
...
//          int days = Period.between(primo, LocalDate.now()).getDays();
    ...
    public void stampaBollettaPDF() {
        try {
            ...
            // Intestazione
            Paragraph intestazione = new Paragraph("Bolletta del " + LocalDate.now() + " || Mobile");
    ...
    public void stampaBollettaConsole() {    	
        ...
        double costoTotale = this.getBolletta();
        String costoTotaleFormattato = decimalFormat.format(costoTotale);
        System.out.println("Bolletta del " + LocalDate.now() + " || Contratto telefonico tipo: Mobile" + " || Utente: " + this.getDatiUtente() + " || Num. Telefonate: " + this.getNumTelefonate() + " || Costo Totale: €" + costoTotaleFormattato);
        System.out.println("------------------------------------------------------------------------------");
